...
//Don't hardcode this. 
//Also imageLocations is bad too.
...
function initialize() {
    ...
    return function() {
      ...
      infowindow.setContent(locations[i][0] + " on 4/"+Math.floor(3+ Math.random() * 10)+" with "+Math.floor(1+ Math.random() * 4) +" friends <br>friends <br> <a href='minigame.html'> Go to the minigame. </a> ");
